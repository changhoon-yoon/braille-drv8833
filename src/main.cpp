...
// ---------- 코일 핀 표 {밀기 핀, 당기기/홀드 핀} ----------
// 행 우선 배치: 코일0=왼위, 코일1=중위, 코일2=오른위, ... 코일8=오른아래
// 물리 배선은 코일 i → DRV8833 {IN1=첫 GPIO, IN2=둘째 GPIO} (README 핀맵)인데,
// 코일 0/4/5/6은 감은 방향(또는 코일 선 극성)이 반대라 밀기/당기기가 뒤집혀 있음.
// → 납땜 대신 이 표에서 두 핀을 맞바꿔 극성 보정 (2026-08-30 실측). 푸시·풀·홀드·o 전부 이 표를 따름.
